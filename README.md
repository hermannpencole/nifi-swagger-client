...
```
libraryDependencies += "com.github.hermannpencole" % "nifi-swagger-client" % "1.0.0"
```
...
```groovy
compile "com.github.hermannpencole:nifi-swagger-client:1.0.0"
```
...
1.0.0 is build with API Nifi 1.0.0
