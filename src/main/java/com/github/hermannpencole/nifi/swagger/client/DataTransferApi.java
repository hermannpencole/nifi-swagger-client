...
public class DataTransferApi {
    ...
    private com.squareup.okhttp.Call commitInputPortTransactionCall(String portId, String transactionId, Integer responseCode, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call commitInputPortTransactionValidateBeforeCall(String portId, String transactionId, Integer responseCode, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = commitInputPortTransactionCall(portId, transactionId, responseCode, progressListener, progressRequestListener);
        return call;
     ...
     * @param responseCode The response code. Available values are BAD_CHECKSUM(19), CONFIRM_TRANSACTION(12) or CANCEL_TRANSACTION(15). (optional)
     * @return TransactionResultEntity
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public TransactionResultEntity commitInputPortTransaction(String portId, String transactionId, Integer responseCode) throws ApiException {
        ApiResponse<TransactionResultEntity> resp = commitInputPortTransactionWithHttpInfo(portId, transactionId, responseCode);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<TransactionResultEntity> commitInputPortTransactionWithHttpInfo(String portId, String transactionId, Integer responseCode) throws ApiException {
        com.squareup.okhttp.Call call = commitInputPortTransactionValidateBeforeCall(portId, transactionId, responseCode, null, null);
     ...
     */
    public com.squareup.okhttp.Call commitInputPortTransactionAsync(String portId, String transactionId, Integer responseCode, final ApiCallback<TransactionResultEntity> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = commitInputPortTransactionValidateBeforeCall(portId, transactionId, responseCode, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<TransactionResultEntity>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /* Build call for commitOutputPortTransaction */
    private com.squareup.okhttp.Call commitOutputPortTransactionCall(String portId, String transactionId, Integer responseCode, String checksum, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call commitOutputPortTransactionValidateBeforeCall(String portId, String transactionId, Integer responseCode, String checksum, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = commitOutputPortTransactionCall(portId, transactionId, responseCode, checksum, progressListener, progressRequestListener);
        return call;
     ...
     * @param transactionId The transaction id. (required)
     * @param responseCode The response code. Available values are CONFIRM_TRANSACTION(12) or CANCEL_TRANSACTION(15). (optional)
     * @param checksum A checksum calculated at client side using CRC32 to check flow file content integrity. It must match with the value calculated at server side. (optional)
     * @return TransactionResultEntity
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public TransactionResultEntity commitOutputPortTransaction(String portId, String transactionId, Integer responseCode, String checksum) throws ApiException {
        ApiResponse<TransactionResultEntity> resp = commitOutputPortTransactionWithHttpInfo(portId, transactionId, responseCode, checksum);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<TransactionResultEntity> commitOutputPortTransactionWithHttpInfo(String portId, String transactionId, Integer responseCode, String checksum) throws ApiException {
        com.squareup.okhttp.Call call = commitOutputPortTransactionValidateBeforeCall(portId, transactionId, responseCode, checksum, null, null);
        Type localVarReturnType = new TypeToken<TransactionResultEntity>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call commitOutputPortTransactionAsync(String portId, String transactionId, Integer responseCode, String checksum, final ApiCallback<TransactionResultEntity> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = commitOutputPortTransactionValidateBeforeCall(portId, transactionId, responseCode, checksum, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<TransactionResultEntity>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void transferFlowFiles(String portId, String transactionId) throws ApiException {
        transferFlowFilesWithHttpInfo(portId, transactionId);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> transferFlowFilesWithHttpInfo(String portId, String transactionId) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call transferFlowFilesAsync(String portId, String transactionId, final ApiCallback<Void> callback) throws ApiException {
