...
public class OutputPortsApi {
    ...
    private com.squareup.okhttp.Call removeOutputPortCall(String id, Object version, Object clientId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call removeOutputPortValidateBeforeCall(String id, Object version, Object clientId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PortEntity removeOutputPort(String id, Object version, Object clientId) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PortEntity> removeOutputPortWithHttpInfo(String id, Object version, Object clientId) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call removeOutputPortAsync(String id, Object version, Object clientId, final ApiCallback<PortEntity> callback) throws ApiException {
     ...
     * 
     * @param id The output port id. (required)
     * @param body The output port configuration details. (optional)
     * @return PortEntity
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
