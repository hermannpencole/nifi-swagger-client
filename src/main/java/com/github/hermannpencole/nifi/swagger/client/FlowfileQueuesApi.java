...
public class FlowfileQueuesApi {
    ...
    private com.squareup.okhttp.Call downloadFlowFileContentCall(String id, String flowfileUuid, Object clientId, String clusterNodeId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call downloadFlowFileContentValidateBeforeCall(String id, String flowfileUuid, Object clientId, String clusterNodeId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void downloadFlowFileContent(String id, String flowfileUuid, Object clientId, String clusterNodeId) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> downloadFlowFileContentWithHttpInfo(String id, String flowfileUuid, Object clientId, String clusterNodeId) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call downloadFlowFileContentAsync(String id, String flowfileUuid, Object clientId, String clusterNodeId, final ApiCallback<Void> callback) throws ApiException {
