...
public class ProcessorDTO {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, parentGroupId, position, name, type, bundle, state, style, relationships, description, supportsParallelProcessing, supportsEventDriven, supportsBatching, persistsState, restricted, multipleVersionsAvailable, inputRequirement, config, validationErrors, extensionMissing);
  }
