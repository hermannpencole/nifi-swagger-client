...
public class ProcessorDTO {
  ...
  **/
   ...
   * @return deprecated
  **/
  @ApiModelProperty(example = "null", value = "Whether the processor has been deprecated.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Whether the processor has multiple versions available.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, parentGroupId, position, name, type, bundle, state, style, relationships, description, supportsParallelProcessing, supportsEventDriven, supportsBatching, persistsState, restricted, deprecated, multipleVersionsAvailable, inputRequirement, config, validationErrors, extensionMissing);
  }
