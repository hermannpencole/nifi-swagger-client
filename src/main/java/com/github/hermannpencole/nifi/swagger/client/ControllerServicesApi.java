...
public class ControllerServicesApi {
     ...
     * 
     * @param id The controller service id. (required)
     * @param propertyName The property name to return the descriptor for. (optional)
    ...
    private com.squareup.okhttp.Call removeControllerServiceCall(String id, Object version, Object clientId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call removeControllerServiceValidateBeforeCall(String id, Object version, Object clientId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ControllerServiceEntity removeControllerService(String id, Object version, Object clientId) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ControllerServiceEntity> removeControllerServiceWithHttpInfo(String id, Object version, Object clientId) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call removeControllerServiceAsync(String id, Object version, Object clientId, final ApiCallback<ControllerServiceEntity> callback) throws ApiException {
     ...
     * 
     * @param id The controller service id. (required)
     * @param body The controller service request update request. (optional)
