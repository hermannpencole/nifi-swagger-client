...
import com.github.hermannpencole.nifi.swagger.client.model.RemoteProcessGroupContentsDTO;
...
public class RemoteProcessGroupDTO {
  ...
  **/
   ...
   * @return targetUri
  **/
  @ApiModelProperty(example = "null", value = "The target URI of the remote process group. If target uri is not set, but uris are set, then returns the first url in the urls. If neither target uri nor uris are set, then returns null.")
   ...
   * @return targetUris
  **/
  @ApiModelProperty(example = "null", value = "The target URI of the remote process group. If target uris is not set but target uri is set, then returns a collection containing the single target uri. If neither target uris nor uris are set, then returns null.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The validation errors for the remote process group. These validation errors represent the problems with the remote process group that must be resolved before it can transmit.")
