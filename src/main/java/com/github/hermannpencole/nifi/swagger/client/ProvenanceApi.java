...
public class ProvenanceApi {
    ...
    private com.squareup.okhttp.Call getProvenanceCall(String id, String clusterNodeId, Boolean summarize, Boolean incrementalResults, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
     ...
     * @param id The id of the provenance query. (required)
     * @param clusterNodeId The id of the node where this query exists if clustered. (optional)
     * @param summarize Whether or not incremental results are returned. If false, provenance events are only returned once the query completes. This property is true by default. (optional)
     * @param incrementalResults Whether or not to summarize provenance events returned. This property is false by default. (optional)
     * @return ProvenanceEntity
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
