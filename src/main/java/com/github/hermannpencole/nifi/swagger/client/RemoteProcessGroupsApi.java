...
public class RemoteProcessGroupsApi {
    ...
    private com.squareup.okhttp.Call removeRemoteProcessGroupCall(String id, Object version, Object clientId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call removeRemoteProcessGroupValidateBeforeCall(String id, Object version, Object clientId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public RemoteProcessGroupEntity removeRemoteProcessGroup(String id, Object version, Object clientId) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<RemoteProcessGroupEntity> removeRemoteProcessGroupWithHttpInfo(String id, Object version, Object clientId) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call removeRemoteProcessGroupAsync(String id, Object version, Object clientId, final ApiCallback<RemoteProcessGroupEntity> callback) throws ApiException {
     ...
     * 
     * @param id The remote process group id. (required)
     * @param body The remote process group. (optional)
     * @return RemoteProcessGroupEntity
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
     ...
     * @param body The remote process group port. (optional)
