...
public class ControllerServiceDTO {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, parentGroupId, position, name, type, bundle, controllerServiceApis, comments, state, persistsState, restricted, multipleVersionsAvailable, properties, descriptors, customUiUrl, annotationData, referencingComponents, validationErrors, extensionMissing);
  }
