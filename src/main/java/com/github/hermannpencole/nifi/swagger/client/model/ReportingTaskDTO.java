...
public class ReportingTaskDTO {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Whether the reporting task has multiple versions available.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, parentGroupId, position, name, type, bundle, state, comments, persistsState, restricted, multipleVersionsAvailable, schedulingPeriod, schedulingStrategy, defaultSchedulingPeriod, properties, descriptors, customUiUrl, annotationData, validationErrors, activeThreadCount, extensionMissing);
  }
