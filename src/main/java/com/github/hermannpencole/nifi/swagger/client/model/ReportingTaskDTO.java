...
public class ReportingTaskDTO {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, parentGroupId, position, name, type, state, comments, persistsState, restricted, schedulingPeriod, schedulingStrategy, defaultSchedulingPeriod, properties, descriptors, customUiUrl, annotationData, validationErrors, activeThreadCount);
  }
