...
public class RemoteProcessGroupPortDTO {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, groupId, name, comments, concurrentlySchedulableTaskCount, transmitting, useCompression, exists, targetRunning, connected, batchSettings);
  }
