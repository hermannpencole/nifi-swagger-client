...
import fr.hpencole.nifi.swagger.client.model.LineageEntity;
import fr.hpencole.nifi.swagger.client.model.ProvenanceEntity;
import fr.hpencole.nifi.swagger.client.model.ProvenanceOptionsEntity;
...
public class ProvenanceApi {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getProvenanceValidateBeforeCall(String id, String clusterNodeId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<ProvenanceEntity> getProvenanceWithHttpInfo(String id, String clusterNodeId) throws ApiException {
        com.squareup.okhttp.Call call = getProvenanceValidateBeforeCall(id, clusterNodeId, null, null);
        Type localVarReturnType = new TypeToken<ProvenanceEntity>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    public com.squareup.okhttp.Call getProvenanceAsync(String id, String clusterNodeId, final ApiCallback<ProvenanceEntity> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getProvenanceValidateBeforeCall(id, clusterNodeId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ProvenanceEntity>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
