...
import fr.hpencole.nifi.swagger.client.model.TenantsEntity;
import fr.hpencole.nifi.swagger.client.model.UserEntity;
import fr.hpencole.nifi.swagger.client.model.UserGroupEntity;
import fr.hpencole.nifi.swagger.client.model.UserGroupsEntity;
import fr.hpencole.nifi.swagger.client.model.UsersEntity;
...
public class TenantsApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public TenantsEntity searchCluster(String q) throws ApiException {
        ApiResponse<TenantsEntity> resp = searchClusterWithHttpInfo(q);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<TenantsEntity> searchClusterWithHttpInfo(String q) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call searchClusterAsync(String q, final ApiCallback<TenantsEntity> callback) throws ApiException {
